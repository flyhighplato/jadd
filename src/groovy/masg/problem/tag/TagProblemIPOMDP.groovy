...
class TagProblemIPOMDP implements TagProblemModel {
	...
	public TagProblemIPOMDP() {
		...
		builder.addAction("actMe", 4);
		builder.addActionOther("actOther", 4);
		...
		builder.setRewardFunction(["w_row","w_col","a1_row","a1_col","a2_row","a2_col"], ["actMe"], ["actOther"]) { Map variables ->
		...
		builder.addTransition(["a1_col"], ["actMe"], ["actOther"], ["a1_col'"]) {Map variables ->
			int col = variables["a1_col"]
			int act = variables["actMe"]
		...
		builder.addTransition(["a1_row"], ["actMe"], ["actOther"], ["a1_row'"]) {Map variables ->
		...
		builder.addTransition(["a2_col"], ["actMe"], ["actOther"], ["a2_col'"]) {Map variables ->
			int col = variables["a2_col"]
			int act = variables["actOther"]
		...
		builder.addTransition(["a2_row"], ["actMe"], ["actOther"], ["a2_row'"]) {Map variables ->
		...
		builder.addTransition(["w_row","w_col"], ["actMe"], ["actOther"], ["w_row'","w_col'"]) {
			Map variables ->
		...
		builder.addObservation(["w_row'","w_col'","a1_row'","a1_col'"], ["actMe"], ["actOther"], ["w_pres"]) { Map variables ->
			int w_row = variables["w_row'"]
			int w_col = variables["w_col'"]
			int a1_row = variables["a1_row'"]
			int a1_col = variables["a1_col'"]
		...
		builder.addObservation(["a1_col'"], ["actMe"], ["actOther"], ["a1_col_loc"]) { Map variables ->
			int a1_col = variables["a1_col'"]
		...
		builder.addObservation(["a1_row'"], ["actMe"], ["actOther"], ["a1_row_loc"]) { Map variables ->	
			int a1_row = variables["a1_row'"]
