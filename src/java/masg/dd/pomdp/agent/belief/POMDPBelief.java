...
public class POMDPBelief implements Belief {
	final POMDP p;
	...
	public POMDPBelief(POMDP p, FactoredCondProbDD fn) {
		this.p = p;
		this.beliefFn = fn;
	...
	public POMDPBelief getNextBelief(HashMap<DDVariable,Integer> actSpacePt, HashMap<DDVariable,Integer> obsSpacePt) {
		...
		return new POMDPBelief(p,nextBeliefFns.get(actSpacePt).get(obsSpacePt));
	}
